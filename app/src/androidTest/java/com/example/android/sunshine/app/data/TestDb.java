...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        long weatherRowId;
        weatherRowId = db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, weatherTestValues);
        ...
        TestUtilities.validateCurrentRecord("Error: Weather Query Validation Failed", c,
                weatherTestValues);
    ...
    public long insertLocation() {
        ...
        assertFalse("Error: More then one record returned from the location query", c.moveToNext());
